...
class TrigramModel(object):
    ...
    def raw_trigram_probability(self, trigram):
        ...
        elif trigram[0:2] == ('START',
                              'START'):  # based on the ED discussion, we should consider the case when trigram[0:2] is ('START', 'START') and set c_uv = total_number_of_sentences
    ...
    def raw_bigram_probability(self, bigram):
        ...
        'START',):  # based on the ED discussion, we should consider the case when bigram[0:1] is ('START',) and set c_u = total_number_of_sentences
    ...
    def smoothed_trigram_probability(self, trigram):
        ...
        p = lambda1 * self.raw_trigram_probability(trigram) + lambda2 * self.raw_bigram_probability(
